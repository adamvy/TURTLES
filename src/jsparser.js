...
{ word |
  [ word lit [ '_ 'a 'z range 'A 'Z range '0 '9 range ] alt notp ] 0 seq1 tok
} ::jsKeyword
...
|
  ...
  { o | [ 'let jsKeyword o .lhs [ '= o .expr ] 1 seq1 opt ] seq } :letStmt
  { o | [ 'return jsKeyword o .expr opt ] seq } :returnStmt
  { o | [ 'function jsKeyword o .lhs '( o .params ') o .block ] seq } :functionDecl
  { o | [ 'function jsKeyword o .lhs opt '( o .params ') o .block ] seq } :functionExpr
  { o | o .lhs ', lit delim } :params
  { o | [ o .arrowParams '=> o .arrowBody ] seq } :arrow
  { o | [ [ '( o .params ') ] 1 seq1 o .lhs { name | [ name ] } mapp ] alt } :arrowParams
  { o | [ o .block o .expr ] alt } :arrowBody
  { o | [ 'if jsKeyword '( o .expr ') o .stmt [ '; lit opt 'else jsKeyword o .stmt ] 2 seq1 opt ] seq } :if
  { o | [ 'while jsKeyword '( o .expr ') o .stmt ] seq } :while
  { o | [ '{ o .stmts '} ] 1 seq1 } :block
  { o | [
    [ [ o .compoundStmt '; lit opt ] 0 seq1 [ o .simpleStmt '; ] 0 seq1 ] alt star
    o .simpleStmt opt
  ] seq { a | [ a 0 @ { child | child } do a 1 @ { | a 1 @ } if ] } mapp } :stmts
  [ '== '= litMap '!= ] alt :equality
  [ '<= '< '>= '> ] alt :inequality
  '&& lit :and
  '|| lit :or
  ...
  { o | [ [ o .lhs [ '++ '-- ] alt ] seq o .expr16 ] alt } :expr15
  { o | o .expr17 } :expr16
  { o | [ o .expr18 o .postfix star ] seq } :expr17
  { o | [ o .indexPart o .callPart ] alt } :postfix
  { o | [ '[ o .expr '] ] 1 seq1 } :indexPart
  { o | [ '( o .expr ', lit delim ') ] 1 seq1 } :callPart
  ...
  { o | [ '- o .expr14 ] 1 seq1 } :unaryMinus
  { o | [ [ '-- '++ ] alt o .lhs ] seq } :iPrefix
  { o | [ '( o .expr ') ] 1 seq1 } :group
  { o | [
    [ o .digit plus &join mapp [ '. o .digit star &join mapp ] seq &join mapp opt ] seq &joinPresent mapp
    [ '. o .digit plus &join mapp ] seq { a | " 0" a join + } mapp
  ] alt } :numberBase
  { o | [ [ 'e 'E ] alt '+- anyChar opt o .digit plus &join mapp ] seq &joinPresent mapp } :exponent
  ...
  { o | [ tab cr nl "  " ] alt plus } :space
  { o | [ " //" nl notChars star nl ] seq } :comment
  ...
  { o | [
    ...
    [
      ...
      [ '_ 'a 'z range 'A 'Z range '0 '9 range ] alt star &join mapp
    ] seq &join mapp tok
  ] 1 seq1 } :lhs
  { o | o .lhs } :variable
  { | ?? }
  ...
  { m | m switch
    ...
    'arrow { | m super { a |
      a 0 @ a 2 @ array?
        { | a 2 @ }
        { | [ 'block [ [ 'return a 2 @ ] ] ] }
      ifelse false __js$jsEmitFunction
    } action }
    ...
    'expr15     { | m super { a | a array? { | [ " '" a 0 @ "  ?? __js$dup 1 " a 1 @ '++ = { | '+ } { | '- } ifelse "  :" a 0 @ ] join } { | a } ifelse } action }
    ...
    'unaryMinus { | m super { | "  __js$neg" + } action }
...
scope['js{'] = code => {
  ...
  if ( typeof compiled !== 'string' ) throw new SyntaxError('Invalid JS-like source');
